...
class GraphPlotter3D {
  ...
  _generatePoints() {
    this.gridSize.x = Math.floor(Math.abs(this.range.x[0] - this.range.x[1])/this.step) + 1, 
    this.gridSize.y =  Math.floor(Math.abs(this.range.y[0] - this.range.y[1])/this.step) + 1;
